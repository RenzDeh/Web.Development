...
const setup = () => {
    ...
    image[0].setAttribute("src", global.IMAGE_PATH_PREFIX + randomImage.toString(10) + global.IMAGE_PATH_SUFFIX);
    image[0].setAttribute("style", 'size: ' + global.IMAGE_SIZE.toString(10) + 'px;');
...
const newImage = () => {
    let oldImg = document.getElementsByClassName("image")[0];
...
const knop = () => {
    ...
    let huidigeFoto = document.getElementsByTagName("img");
    huidigeFoto[0].addEventListener("click", newImage);
